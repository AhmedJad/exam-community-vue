      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2">{{ $t("Adventure starts here") }}🚀</h4>
            <p class="mb-4">{{ $t("Make your app management easy and fun!") }}</p>

            <form @submit.prevent="register" id="formAuthentication" class="mb-3" action="index.html" method="POST">
              <div class="mb-3">
                <label for="username" class="form-label">{{ $t("USER_NAME") }}</label>
                <input
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="terms-conditions">
                    {{$t("I agree to")}}
                    <a href="javascript:void(0);">{{$t("privacy policy & terms")}}</a>
                  </label>
                </div>
              </div>
              <button class="btn btn-primary d-grid w-100">{{$t("Sign up")}}</button>
            </form>
            <p class="text-center">
